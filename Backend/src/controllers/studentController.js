...
export const getDashboardStats = asyncHandler(async (req, res, next) => {
    ...
    const feedbackNotifications = project?.feedback && project?.feedback.length > 0 ? project.feedback.sort((a, b) => new Date(b.createdAt) - new Date(asyncHandler.createdAt)).slice(0, 2) : [];
