...
import { createStudents, updateStudent, deleteStudent } from "../../store/slices/adminSlice"
...
const ManageStudents = () => {
  ...
  const students = useMemo(() => {
    ...
    return studentUsers.map((student) => {
      const studentProject = (projects || []).find(p => p.student === student._id);
      return {
        ...student,
...

            {
              filteredStudents && filteredStudents.length > 0 ? (<table className="w-full ">
                ...
                filteredStudents.length === 0 && (
                  <div className="text-center py-8 text-slate-500 ">No students found matching to your criteria.</div>
                )
            }
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 ">
                <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 shadow-xl">
                  ...
                  <div className="text-center ">
                    ...
                    <p className="text-slate-500 text-sm mb-4">Are You Sure you want to delete <span>{studentToDelete.name}? This action cannot be undone.</span> </p>
