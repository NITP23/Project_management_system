  ...
  <div className="space-y-6">
      ...
      <div className="grid grid-cols-1  md:grids-cols-3 gap-6">
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="m1-4">
              <p className="text-sm font-medium text-slate-600">Assign Students</p>
              <p className="text-lg font-semibold text-slate-800">{teachers.reduce((sum,t) => sum  + (t.assignedStudents?.length || 0),0)}</p>
            </div>
          </div>
        </div>
      ...
      <div className="card">
        ...
        <div className="overflow-x-auto">
          ...
          {
            filteredTeachers && filteredTeachers.length > 0 ? (  <table className="w-full ">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wide"> Teachers Info</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wide">Department</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wide"> Expertise</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wide">Join Date</th>
                      ...
                      return (
                        <tr key = {teacher._id} className="hover:bg-slate-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap"> 
                            ...
                            {
                              Array.isArray(teacher.experties) ? teacher.experties.join(",") : teacher.experties
                            }
              ...
              <div className="text-center py-8 text-slate-500 ">No Teachers found matching to your criteria.</div>
              )
          }
           ...
           <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 ">
              <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 shadow-xl">
                ...
                <div className="text-center ">
                  ...
                  <p className="text-slate-500 text-sm mb-4">Are You Sure you want to delete <span>{teacherToDelete.name}? This action cannot be undone.</span> </p>
