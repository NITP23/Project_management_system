    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="card-subtitle">View feedback from your supervisor</p>
        </div>
      </div>

      {/* Supervisor feedback Stats */}
      ...
      <div className="space-y-4">
        {
          feedback && feedback.length > 0 ? (
                ...
                <div key={i} className="border border-slate-200 rounded-lg p-4 hover:Shadow-sm transition-shadow">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <p className="">{f.supervisorName || "Supervisor"}</p>
                    </div>
                  </div>


                  <div className="bg-slate-50 rounded-lg mb-3">
                    <p className="text-slate-700 leading released">{f.message || "No Feedback"}</p>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-slate-500">No feedback recieved yet</p>
            </div>
          )
        }
      </div>
