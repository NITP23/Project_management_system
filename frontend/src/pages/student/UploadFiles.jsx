      ...
      <div className="space-y-6 ">
        <div className="card">
          <div className="card-header">
            ...
            <p className="card-subtitle">Upload your project documents including reports, presentations, code files.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 ">
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <p className="text-sm text-slate-600 mb-4">Upload Your Presentation (PPT, PPTx)</p>
              <label className="btn-outline cursor-pointer">
                Choose File
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-2">Codes Files</h3>
              <p className="text-sm text-slate-600 mb-4">Upload Your Source Codes (ZIP, RAR, TAR)</p>
              <label className="btn-outline cursor-pointer">
                Choose File
              ...
              <div className="space-y-3">
                {
                  selectedFiles.map(file => {
                    return <div key={file.name} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
